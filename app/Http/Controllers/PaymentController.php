...
class PaymentController extends BaseController
{
    ...
    public function donations() {
        DonationAttempt::where('user_id', Auth::user()->id)->update(['seen' => 1]);
        ...
        return view("donations", ["orders" => $orders, "subscribed" => $subscribed, "plans" => $plans]);
    }
    ...
    public function accountDetails() {
        ...
        return view("accountDetails", ["orders" => $orders, "subscribed" => $subscribed, "plans" => $plans]);
    }
