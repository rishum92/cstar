        ...
        <div class="row service-list ">
		  ...
		  <option value="">--Select--</option>
                         <option value="[[variable.variable_name]]" ng-repeat="variable in service.variable_list">[[variable.variable_name]]</option>
							...
							<div class="row" ng-if="service.user_id!=1 && service.user_id == <?php echo e(Auth()->user()->id); ?>">
							<div class="col-md-3" style="padding:12px;font-size:17px ">
		  ...
		  <option value="">--Select--</option>
                         <option value="[[variable.variable_name]]" ng-repeat="variable in service.variable_list">[[variable.variable_name]]</option>
							...
							<?php if(Auth()->user()->id != 1): ?>
							<!--<div class="row  _custom_service_box_color" ng-show="[[getCountByUser(<?php echo e(Auth()->user()->id); ?>)]]">-->
