  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <?php echo Form::open(array('name' => 'payment', 'route' => 'payment', 'method' => 'POST', 'novalidate' => 'novalidate')); ?>
          ...
          <div class="payment-plan">
            <div class="payment-options">
              <?php foreach($plans as $key => $plan): ?>
                <div class="radio">
                  <label>
                    <input type="radio" name="plan" <?php if($key == 0): ?> checked <?php endif; ?> id="m<?php echo e($key); ?>" value="<?php echo e($plan->id); ?>">
                    ...
                    <small>Billed in one payment of £<?php echo e($plan->price * $plan->period); ?> <span><?php echo e($plan->best_deal); ?></span></small>
                  </label>
                </div>
              <?php endforeach; ?>  
            </div>
